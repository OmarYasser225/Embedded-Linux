...
#select
select_pos = pyautogui.locateCenterOnScreen("select.png")
pyautogui.click(select_pos)
time.sleep(1)

#select all
select_all_pos = pyautogui.locateCenterOnScreen("select_all.png")
pyautogui.click(select_all_pos)

#select read 
read_pos = pyautogui.locateCenterOnScreen("read.png")
